            ...
            <div class='responsive-table'>
                <div class='scrollable-area'>
                    <table class='table table-bordered table-hover table-striped' style='margin-bottom:0;'>
                        ...
                        -->
                        <tr>
                            <td><a href="index.php?page=user/queue_dru">OPD</a></td>
                            <td>OPD</td>
                            <td>
                                <div class='text-center'>
                                    <a class='btn btn-success btn-mini' href='javascript:void(0);' title="List" onclick="window.open('index.php?page=user/show', '', 'width=400, height='+screen.height);">
                                        <i class='icon-list'></i>
                                    </a>
                                </div>
                            </td>
